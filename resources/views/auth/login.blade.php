...
body {
  background-image: url('https://images.adsttc.com/media/images/6230/4696/3e4b/316a/8700/0005/newsletter/Liberland_Metaverse_MasterPlan_Render_by_Mytaverse_(3).jpg?1647330953');
...
<form class="form" action="{{ route('login') }}" method="post" autocomplete="off">
    ...
    <div class="form-inner">
        <h2>User Login</h2>
        <div class="input-wrapper"><label for="login-username">Username</label>
            <div class="input-group"><span class="icon"><svg viewBox="0 0 24 24">
                        <path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"></path>
                        </svg></span><input type="text" id="login-username" name="email" data-lpignore="true" /></div>
                                     @error('email')
        ...
        <div class="input-wrapper"><label for="login-password">Password</label>
            <div class="input-group"><span class="icon"><svg viewBox="0 0 24 24">
                        ...
                        </svg></span><input type="password" id="login-password" name="password" data-lpignore="true" /></div>
                    			  @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
        ...
        <div class="btn-group"><button class="btn btn--primary">Sign in</button><a class="btn--text" href="#0">Forgot password?</a></div>
    </div>
</form>
...
<script>
    ...
    $(function() {
        $('.agree,.forgot, #toggle-terms, .log-in, .sign-up').on('click', function(event) {
            ...
            if ($(this).hasClass('agree') || $(this).hasClass('log-in') || ($(this).is(
                    '#toggle-terms')) && terms.hasClass('open')) {
            ...
            } else if ($(this).hasClass('forgot') || $(this).hasClass('sign-up') || $(this).is(
                    '#toggle-terms')) {
